...
public class Gaia {
    ...
    */
    ...
    public static final int COMMAND_SET_FM_FREQ_CONTROL = 0x022E;
    public static final int COMMAND_GET_FM_FREQ_CONTROL = 0x02AE;
    ...
    public static final int GAIA_COMMAND_6CH_START_REC = 0x0801;//开始录音
    public static final int GAIA_COMMAND_6CH_STOP_REC = 0x0802;//结束录音
    public static final int GAIA_COMMAND_6CH_READ_CURRENT = 0x0803;//获得当前最大通通
    public static final int GAIA_COMMAND_6CH_READ_ACCUMULATE = 0x0804;//获得上次录音后最大通道
