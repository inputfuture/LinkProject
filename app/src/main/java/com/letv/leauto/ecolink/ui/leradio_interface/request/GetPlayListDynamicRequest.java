 ...
 */
public class GetPlayListDynamicRequest extends LetvHttpDynamicRequest<LetvHttpBaseModel> {
    private boolean isSync = false;

    public GetPlayListDynamicRequest(Context context, TaskCallBack callback, boolean isSync) {
    ...
    public LetvHttpBaseUrlBuilder getRequestUrl(LetvBaseParameter params) {
        return new DynamicUrlBuilder(GlobalHttpPathConfig.GET_MUSIC_LIST, params);
    }
