...
@SuppressLint("NewApi") public class NotificationMonitorService extends NotificationListenerService {
...
//            Intent intent = new Intent(HomeActivity.INTENT_ACTION_NOTIFICATION);
...
//        }
		 ...
		 *Trace.Info("SevenNLS", "notificationTitle:"+notificationTitle);
		 *Trace.Info("SevenNLS", "notificationText:"+notificationText);
		 *Trace.Info("SevenNLS", "notificationSubText:"+notificationSubText);
		 *Trace.Info("SevenNLS",
