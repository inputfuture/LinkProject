...
//        });
    ...
    public static void putJson(Object tag, String url, Map<String, String> headers, String json, final PostCallBack postCallBack) {
    ...
    public static void deleteJson(Object tag, String url, Map<String, String> headers, String json, final PostCallBack postCallBack) {
        ...
        if (mClient != null) {
            ...
            mCall.enqueue(new Callback() {
                              ...
                              public void onResponse(Call call, Response response) {
                                  ...
                                  if (response.isSuccessful()||url.contains("Config.HTTP_DATA_PATH")) {
