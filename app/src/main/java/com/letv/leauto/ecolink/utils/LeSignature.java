...
public class LeSignature {
    ...
    public static String getSignature(String accessKey, String secretKey, Map<String, String> params, long time) {
        ...
        try {
            ...
            Trace.Info("TAG", "getSignature: "+str2Sign);
    ...
    public static String getSignature(String accessKey, String method, String path, byte[] body, long time, Map<String, String> params) {
