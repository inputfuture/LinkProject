 ...
 *******************************************************************************/
package com.letv.leauto.ecolink.library;
...
import com.letv.leauto.ecolink.library.internal.FlipLoadingLayout;
import com.letv.leauto.ecolink.library.internal.LoadingLayout;
import com.letv.leauto.ecolink.library.internal.RotateLoadingLayout;
import com.letv.leauto.ecolink.library.internal.Utils;
import com.letv.leauto.ecolink.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		...
		if (DEBUG) {
			Trace.Debug(LOG_TAG, "addView: " + child.getClass().getSimpleName());
		}
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		if (DEBUG) {
			Trace.Debug(LOG_TAG, String.format("onSizeChanged. W: %d, H: %d", w, h));
		}
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			Trace.Debug(LOG_TAG, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
		}
