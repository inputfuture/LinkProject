 ...
 * All rights Reserved, Designed By Golo  
 * Copyright: Copyright(C) 2014-2020  
 * Company: Golo.  
 * @author: jihu 
 * @version V1.0    
 * Createdate: 2014年11月22日 下午2:55:40  
 *   
 * Modification  History:   
 * Date         Author        Version        Discription  
 *    
 * 2014年11月22日       wu.zh          1.0             1.0  
 ...
 * @Description:TODO(Activity的管理器)
 * @author: wanghuayan
 * @date: 2014年11月22日 下午2:55:40
 */
public final class EcoActivityManager {
    ...
    private static class ManagerHolder {
        private static final EcoActivityManager instance = new EcoActivityManager();
    }

    public static EcoActivityManager create() {
