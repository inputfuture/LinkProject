...
public class GPSLocationManager {
    ...
    private GPSStatus mSatelliteListener;
    ...
    public void start(final GPSLocationListener gpsLocationListener, boolean isOpenGps) {
        ...
        locationManager.addGpsStatusListener(mSatelliteListener);
    ...
    public void stop() {
        if (mContext.get() != null) {
            ...
            locationManager.removeGpsStatusListener(mSatelliteListener);
        }
    }
