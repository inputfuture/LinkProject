...
public class UIUtils {
     ...
     * 收藏渐变规则
     */
    private static final float[] collectionAniScaleRec = new float[] { 1.0f,
            0.6f, 1.5f, 0.8f, 1.0f };
    ...
    /**
     * get text width with the specified parameter
     * @param text
     *            text string that needs to be measured.
     * @param textSize
     *            size of the text to be render with
     * @param typeface
     *            type face of the text to be rendered
     * @return text width with the specified parameter
     */
