...
//    public static final boolean NOT_HANDLED = false;
    ...
    public static class LogRec {
         ...
         * processed.
         */
        LogRec(StateMachine sm, Message msg, String info, State state, State orgState,
               State transToState) {
         ...
         */
        public void update(StateMachine sm, Message msg, String info, State state, State orgState,
                           State dstState) {
            mSm = sm;
...
//        }
    ...
    private static class LogRecords {
         ...
         *
         */
        synchronized void add(StateMachine sm, Message msg, String messageInfo, State state,
                              State orgState, State transToState) {
            mCount += 1;
    ...
    private static class SmHandler extends Handler {
        ...
        /** @see StateMachine#transitionTo(State) */
        private final void transitionTo(State destState) {
